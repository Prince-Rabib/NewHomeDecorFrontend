...
const AuthModal = (props) => {
  ...
  const submitHandler = (event) => {
    ...
    if (isLogin && !isAdminMode) {
      url =
        'https://new-home-decor-backend.vercel.app/auth/user/login';
      method = 'POST';  
      bodyContent = {
        email,
        password
    ...
    if (!isLogin && !isAdminMode) {
      url =
        'https://new-home-decor-backend.vercel.app/auth/user/signup';
        method = 'PUT';    
      bodyContent = {
        name,
        email,
    ...
    if (isLogin && isAdminMode) {
      url =
        'https://new-home-decor-backend.vercel.app/auth/admin/login';
      method = 'POST';  
      bodyContent = {
        email,
        password
    ...
    if (!isLogin && isAdminMode) {
      ...
      url =
        'https://new-home-decor-backend.vercel.app/auth/admin/signup';
        method = 'PUT';    
      bodyContent = {
        name,
        email,
